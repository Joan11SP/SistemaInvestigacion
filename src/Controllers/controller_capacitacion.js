...
const saveCapacitacion = async (req,res)=>{
    const {persona,tipo,instructor,fecha_inicio,fecha_fin,name} =req.body
    const save = await new capacitacion({
        persona,tipo,instructor,fecha_inicio,fecha_fin,name
    });
    save.save();
...
const updateCapacitacion = async (req,res)=>{
    const {_id,persona,tipo,instructor,fecha_inicio,fecha_fin,name} =req.body
    const update = await capacitacion.updateOne({_id:_id},{
        $set:{persona,tipo,instructor,fecha_inicio,fecha_fin,name}
    });
